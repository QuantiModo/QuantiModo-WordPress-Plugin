...
CURRENTDIR=`pwd`
MAINFILE="quantimodo.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/quantimodo/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="mikepsinn" # your svn username
