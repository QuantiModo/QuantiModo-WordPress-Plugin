...
QuantiModo allows your users to record, aggregate, analyze and visualize their health and life-tracking data.
...
3. Visit https://app.quantimodo.com/builder and copy your client id
4. Go to Settings -> QuantiModo in your WordPress wp-admin area and paste the client id, select Enabled and save!
