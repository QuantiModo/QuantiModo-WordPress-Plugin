...
Quantimodo = function() 
{
	...
	else if(window.location.hostname == "dev-met.quantimo.do")
	{
		var url = "https://dev-met.quantimo.do/api/";
	}
	...
	return {
		...
		// Get variab;es for Personal Studies Plugin
	    getVariableUserSettings: function(params, f) { GET('variableUserSettings', ['variableName'], params, f); },
		postVariableUserSettings: function(measurements, f) { POST('variableUserSettings', ['qm_postmeta'], measurements, f); },
		...
		postCorrelateShare: function(measurements, f) { POST('share', ['type', 'causeVariable', 'effectVariable'], measurements, f); },
