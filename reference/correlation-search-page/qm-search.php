 ...
 * Initial code for Top Treatments and Top Causes Pages
 * Finds correlations with a given search term.  Can be modified to only show correlations with a
 * specific term like "Overall Mood"
 */
