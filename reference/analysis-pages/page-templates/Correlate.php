...
<div class="dialog transitions" id="share-dialog">
	...
	<div id="share-resultcontainer"> 
		<div class="label" id="ext-gen848">Link to your share</div>
		<input type="text" size="20" autocomplete="off" id="share-linkcontainer" readonly>
	</div>
</div>
	...
	<section id="section-configure">
		<div id="section-configure-input" class="open">
			<div class="inner">
				...
				<div class="card-header accordion-header" id="accordion-output-header">
					<div style="float: left; line-height: 42px;">
						Output State
					</div>
				</div>
		...
		<div class="closed" id="section-configure-settings">
			<div class="inner">
				<div class="card-header accordion-header" id="accordion-settings-header">
					<div style="float: left; line-height: 42px;">
						Settings
					</div>
				</div>
				<div class="accordion-content closed" id="accordion-settings-content">
					<div class="inner">
						...
						<b style="margin-top: 8px;">Data optimalization</b>
						...
						<div>
							...
							<div>
								...
								<label>Assume data is missing for that day</label>
							</div>
							<div>
								<input type="radio" name="missingAssumptionGroup" id="assumeValue">
								<label>Assume <input id="variableFillingValueSetting" style="text-align: center; width: 50px; height: 26px;" type="text" id="inputVariableMaximumValueSetting" placeholder=""> for that day</label>
							</div>
						</div>
