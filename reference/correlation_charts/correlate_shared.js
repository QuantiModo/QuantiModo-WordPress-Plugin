var AnalyzePage = function() {
	...
	var getInputData = function()
	{
		...
		if (parts[0] == "data")
		{
			...
			function(result) {
				sharedData = result;
				AnalyzeChart.setInputData(sharedData['inputVariable'], sharedData['causeMeasurements']);
				AnalyzeChart.setOutputData(sharedData['outputVariable'], sharedData['effectMeasurements']);
			});
		}
		else
		{
