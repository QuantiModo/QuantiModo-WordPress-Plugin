...
(function () {
    ...
    ra = function (a, b, c) {
        ...
        var a = o(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - Ja), e, f = d[xb](), g = d[yb](), h = d[Ua](), i = d[jb](), j = d[kb](), k = L.lang, l = k.weekdays, d = u({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Qa(h),
            e: h,
    ...
    var nb = K.adapterRun, $b = K.getScript, Aa = K.inArray, q = K.each,
        Fb = K.grep, ac = K.offset, Na = K.map, A = K.addEvent, X = K.removeEvent, N = K.fireEvent, bc = K.washMouseEvent, ob = K.animate, eb = K.stop, K = {
            enabled: !0,
            x: 0,
            y: 15,
    ...
    xa.prototype = {
        init: function (a, b) {
            ...
            if (ma(a))c = a, h === "circle" ? c = {
                    x: "cx",
                    y: "cy"
                }[c] || c : c === "strokeWidth" && (c = "stroke-width"), n = H(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && c !== "fill" && (n = parseFloat(n)); else {
                for (c in a)if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                    e !== r && (d = e);
                    if (c === "d")d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) &&
                    (d = "M 0 0"); else if (c === "x" && h === "text")for (e = 0; e < g.childNodes.length; e++)f = g.childNodes[e], H(f, "x") === H(g, "x") && H(f, "x", d); else if (this.rotation && (c === "x" || c === "y"))p = !0; else if (c === "fill")d = i.color(d, g, c); else if (h === "circle" && (c === "x" || c === "y"))c = {
                            x: "cx",
                            y: "cy"
                        }[c] || c; else if (h === "rect" && c === "r")H(g, {
                        rx: d,
                        ry: d
                    }), j = !0; else if (c === "translateX" || c === "translateY" || c === "rotation" || c === "verticalAlign" || c === "scaleX" || c === "scaleY")j = p = !0; else if (c === "stroke")d = i.color(d, g, c); else if (c === "dashstyle")if (c =
                    ...
                    } else if (c === "width")d = E(d); else if (c === "align")c = "text-anchor", d = {
                        left: "start",
                        center: "middle",
                        right: "end"
                    }[d];
    ...
    sa.prototype = {
        Element: xa, init: function (a,
            ...
            q(e, function (e, f) {
                ...
                q(l, function (e) {
                    if (e !== "" || l.length === 1) {
                        ...
                        t.length);)delete a.bBox, r = a.getBBox(), s = r.width, !da && c.forExport && (s = c.measureSpanWidth(o.firstChild.data, a.styles)), r = s > k, !r || e.length === 1 ? (e = t, t = [], e.length && (fa++, v && fa * u > v ? (e = ["..."], a.attr("title", a.textStr)) : (o = F.createElementNS(Ma, "tspan"), H(o, {
                            dy: u,
                            x: i
                        }), q && H(o, "style", q), b.appendChild(o), s > k && (k = s)))) : (o.removeChild(o.firstChild), t.unshift(e.pop())), e.length && o.appendChild(F.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        }, button: function (a, b, c, d, e, f, g, h, i) {
            var j = this.label(a, b, c, i,
                null, null, null, null, "button"), k = 0, l, m, p, n, $, o, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            if (h)g = this.path(h), u(g, {
                ...
                width: d,
                height: e
            }), f && u(g, f); else if (i.test(a))k = function (a, b) {
                a.element && (a.attr({
                    width: b[0],
                    height: b[1]
            ...
            if (g) {
                ...
                g === "radialGradient" && b && !t(c.gradientUnits) && (c = w(c, {
    ...
    u(xa.prototype, {
        htmlCss: function (a) {
            ...
            try {
                ...
                console.log('we avoided highstock error');
            }
            ;
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        if (i > l && /[ \-]/.test(b.textContent || b.innerText))z(b, {
                            width: l + "px",
                            display: "block",
                            whiteSpace: "normal"
                        }), i = l;
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        q(d.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || Z(Ta, {className: H(a.element, "class")}, {
                                    position: "absolute",
    ...
    var rb, qa;
    if (!da && !ka)Highcharts.VMLElement = qa = {
        init: function (a, b) {
            ...
            if (ma(a))c = a, n = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a)if (d =
                ...
                (g[c] = d), m = !0; else if (Aa(c, ["x", "y", "width", "height"]) !== -1)this[c] = d, c === "x" || c === "y" ? c = {
                    x: "left",
                    y: "top"
    ...
    Ya.prototype = {
        addLabel: function () {
            ...
            if (m &&
                x)t === "inside" && (x = -x), d.opposite && (x = -x), h = this.getMarkPath(G, w, x, m * C, g, f), p ? p.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: s, "stroke-width": m, opacity: c}).add(d.axisGroup);
    ...
    Qb.prototype = {
        destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g =
                c.translate(this.percent ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = O(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {
                x: e ? f ? g : g - c : h,
    ...
    W.prototype = {
        ...
        getExtremes: function () {
            var a = this.isLog;
            return {
                min: a ? ga(na(this.min)) : this.min,
                max: a ? ga(na(this.max)) : this.max,
        ...
        getOffset: function () {
            ...
            if (p && p.text && p.enabled !== !1) {
                if (!a.axisTitle)a.axisTitle =
                    c.text(p.text, 0, 0, p.useHTML).attr({
                        zIndex: 7,
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = E(e.style.fontSize || 12), d = {
                low: f + (a ? 0 : d),
                middle: f + d / 2,
                high: f + (a ? d : 0)
            }[e.align], b = (a ? c + this.height : b) +
        ...
        render: function () {
            ...
            if (u || h)if (a.minorTickInterval && !a.categories && q(a.getMinorTickPositions(), function (b) {
                    ...
                    if (c % 2 === 0 && b < a.max)n[b] || (n[b] = new Ib(a)), I = b + x, G = i[c + 1] !== r ? i[c + 1] + x : a.max, n[b].options = {
                        from: g ? na(I) : I,
                        to: g ? na(G) : G,
                        color: J
            ...
            if (s)b = a.getLinePath(s), a.axisLine ? a.axisLine.animate({d: b}) : a.axisLine = e.path(b).attr({
                stroke: f.lineColor,
                "stroke-width": s,
                zIndex: 7
    ...
    Ab.prototype = {
        init: function (a, b) {
            ...
            i = i.call(h, this);
            h = a.series;
            i === !1 ? this.hide() : (this.isHidden && (eb(d), d.attr("opacity", 1).show()), d.attr({text: i}), k = e.borderColor || a.color || h.color || "#606060", d.attr({stroke: k}), this.updatePosition({
                plotX: f,
                plotY: g
            }), this.isHidden = !1);
    ...
    $a.prototype = {
        init: function (a, b) {
            ...
            } else e && e.followPointer && !e.isHidden && (d = e.getAnchor([{}], a), e.updatePosition({
                plotX: d[0],
                plotY: d[1]
            }));
        ...
        onDocumentMouseMove: function (a) {
            ...
            }), N(c.series, "click", u(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && N(b, "click", a))
            ...
            this._events = c = [[b, "onmousedown", "onContainerMouseDown"], [b, "onmousemove", "onContainerMouseMove"], [b, "onclick", "onContainerClick"], [b, "mouseleave", "onContainerMouseLeave"], [F, "mouseup",
                "onDocumentMouseUp"]];
    ...
    if (V.PointerEvent || V.MSPointerEvent) {
        ...
        U($a.prototype, "setDOMEvents", function (a) {
            ...
            q([[this.chart.container, "PointerDown", "touchstart", "onContainerTouchStart", function (a) {
    ...
    Jb.prototype = {
        ...
        renderItem: function (a) {
            ...
            if (!x && (a.legendGroup = d.g("legend-item").attr({zIndex: 1}).add(b.scrollGroup), r.drawLegendSymbol(b, a), a.legendItem =
                    x = d.text(e.labelFormat ? Ha(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, u).css(w(a.visible ? i : j)).attr({
                        align: m ? "left" : "right",
                        zIndex: 2
                    }).add(a.legendGroup), (u ? x : a.legendGroup).on("mouseover", function () {
                    a.setState("hover");
                    ...
                    a.visible), t))a.checkbox = Z("input", {
                type: "checkbox",
                checked: a.selected,
                defaultChecked: a.selected
            }, e.itemCheckboxStyle, c.container), A(a.checkbox, "click", function (b) {
            ...
            e > d && (e = d);
            if (e > 0)b !== r && Xa(b, this.chart), this.nav.attr({
                translateX: j,
    ...
    ya.prototype = {
        init: function (a, b) {
            ...
            q([["title", a, e], ["subtitle", b, d]], function (a) {
                ...
                d && e && (c[b] = d = d.destroy());
                a && a.text && !d && (c[b] =
                    c.renderer.text(a.text, 0, 0, a.useHTML).attr({
                        align: a.align,
                        "class": "highcharts-" + b,
                        zIndex: a.zIndex || 4
                    }).css(a.style).add())
            ...
            c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), z(b, {
                position: "absolute",
                top: "-9999px",
                display: "block"
            ...
            this.clipBox = {
                x: b,
                y: c,
                width: Q(this.plotSizeX - s(d, h[1]) / 2 - b),
                height: Q(this.plotSizeY - s(d, h[2]) / 2 - c)
            };
            ...
            if (m)g ? g.animate(g.crisp(null, n, o, q, x)) : this.plotBorder = b.rect(n, o, q, x, 0, -m).attr({
    ...
    qa = Highcharts.CenteredSeriesMixin = {
        getCenter: function () {
    ...
    Da.prototype = {
        init: function (a, b, c) {
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && !i.enabled) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic)f = g && this.graphic.symbolName && p[a].r, this.graphic.attr(w(p[a], f ? {
                    x: c - f,
                    y: d - f,
                    width: 2 * f,
                    height: 2 * f
                    ...
                    if (a && i)if (f = i.radius, l = l.symbol || e.symbol, k && k.currentSymbol !== l && (k = k.destroy()), k)k[b ? "animate" : "attr"]({
                        x: c - f,
                        y: d - f
                    }); else e.stateMarkerGraphic = k = m.renderer.symbol(l, c - f, d - f, 2 * f, 2 * f).attr(p[a]).add(e.markerGroup), k.currentSymbol = l;
                    if (k)k[a &&
    ...
    M.prototype = {
        ...
        drawPoints: function () {
            ...
            if (l.enabled || this._hasPointMarkers)for (f =
                                                            b.length; f--;)if (g = b[f], d = Q(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === r || i.enabled, m = c.isInsidePlot(v(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)k.attr({visibility: m ? da ? "inherit" : "visible" : "hidden"}).animate(u({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            var a = this, b = a.options, c = S[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color, h = {
                stroke: g,
                fill: g
            }, i = a.points || [], j = [], k, l = a.pointAttrToOptions, m = b.negativeColor, p = c.lineColor, n = c.fillColor, o;
        ...
        drawGraph: function () {
            ...
            q(c, function (c, h) {
                var k = c[0], l = a[k];
                if (l)eb(l),
                    l.animate({d: g}); else if (d && g.length)l = {
                    stroke: c[1],
                    "stroke-width": d,
                    zIndex: 1
    ...
    u(ya.prototype, {
        addSeries: function (a, b, c) {
            ...
            if (!c)this.loadingDiv = c = Z(Ta,
                {className: "highcharts-loading"}, u(d.style, {
                    zIndex: 10,
                    display: ba
                }), this.container), this.loadingSpan = Z("span", null, d.labelStyle, c);
            this.loadingSpan.innerHTML = a || b.lang.loading;
            if (!this.loadingShown)z(c, {
                opacity: 0,
                display: "",
        ...
        type: "area", getSegments: function () {
            ...
            q(f, function (d) {
                ...
                f ? f.animate({d: b}) : a[e] = a.chart.renderer.path(b).attr({
                    fill: o(d[2], Ba(d[1]).setOpacity(o(c.fillOpacity, 0.75)).get()),
                    zIndex: 0
                }).add(a.group)
            })
    ...
    ia = ea(ia, {
        type: "areaspline",
        closedStacks: !0,
        getSegmentPath: ab.getSegmentPath,
        closeSegment: ab.closeSegment,
    ...
    M.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(a.plotX, a.plotY, g)))d = u({
            x: g ? f.plotWidth - i : h,
            y: v(g ? f.plotHeight - h : i),
            width: 0,
            height: 0
        }, d), u(c, {width: j.width, height: j.height}), c.rotation ? (g = {
            align: c.align,
            x: d.x + c.x + d.width / 2,
            y: d.y + c.y + d.height / 2
        }, b[e ? "attr" : "animate"](g)) : (b.align(c, null, d), g = b.alignAttr, o(c.overflow, "justify") === "justify" ?
    ...
    if (D.pie)D.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = o(e.softConnector, !0), l = e.distance, m = a.center, p = m[2] / 2, n = m[1], r = l > 0, t, x, u, w, y = [[], []], A, I, E, G, C, P = [0, 0, 0, 0], H = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            if (va(P) === 0 || this.verifyDataLabelOverflow(P))this.placeDataLabels(), r && g && q(this.points, function (b) {
                i = b.connector;
                u = b.labelPos;
                if ((t = b.dataLabel) && t._pos)E = t._attr.visibility, A = t.connX, I = t.connY, j = k ? ["M", A + (u[6] === "left" ? 5 : -5), I, "C", A, I, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), I, "L", u[2], u[3], "L", u[4], u[5]], i ? (i.animate({d: j}), i.attr("visibility", E)) : b.connector = i = a.chart.renderer.path(j).attr({
                    "stroke-width": g,
    ...
    u(W.prototype, {
        beforeSetTickPositions: function () {
            ...
            if (!c[d])f = {
                ...
                }, options: {ordinal: !0}, val2lin: W.prototype.val2lin
    ...
    var Y = M.prototype, fc = Y.processData, gc = Y.generatePoints, hc = Y.destroy, ic = Y.tooltipHeaderFormatter, jc = {
        ...
        groupPixelWidth: 2,
        dateTimeLabelFormats: gb("millisecond", ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], "second", ["%A, %b %e, %H:%M:%S",
    ...
    Y.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, l = !!b, m = [[], [], [], []], d = typeof d === "function" ? d : Oa[d], p = this.pointArrayMap, n = p && p.length, o;
        for (o = 0; o <= i; o++) {
    ...
    D.flags = ea(D.column, {
        ...
        drawPoints: function () {
            ...
            for (i = b.length; i--;)if (j = b[i], a = j.plotX > this.xAxis.len, d = j.plotX + (a ? l : -l), k = j.stackIndex, h = j.options.shape || f.shape, e = j.plotY, e !== r && (e = j.plotY + g + l - (k !== r && k * f.stackDistance)), m = k ? r : j.plotX + l, p = k ? r : j.plotY, k = j.graphic, e !== r && d >= 0 && !a)a = j.pointAttr[j.selected ? "select" : ""], k ? k.attr({
                x: d,
                y: e,
                r: a.r,
                anchorX: m,
                anchorY: p
            }) : j.graphic = c.label(j.options.title || f.title || "A", d, e, h, m, p, f.useHTML).css(w(f.style, j.style)).attr(a).attr({
                align: h ===
    ...
    R = gb("linearGradient", {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [[0, "#FFF"], [1, "#CCC"]]);
    K = [].concat(Xb);
    K[4] = ["day", [1, 2, 3, 4]];
    K[5] = ["week", [1, 2, 3]];
    u(L, {
        navigator: {
            ...
            outlineWidth: 1,
            series: {
                type: D.areaspline === r ? "line" : "areaspline",
                color: "#4572A7",
                compare: null,
                fillOpacity: 0.4,
                dataGrouping: {approximation: "average", enabled: !0, groupPixelWidth: 2, smoothed: !0, units: K},
            ...
            yAxis: {
                ...
                maxPadding: 0.1,
                labels: {enabled: !1},
                crosshair: {enabled: !1, label: {enabled: !1}},
                title: {text: null},
                tickWidth: 0
            }
        }, scrollbar: {
            ...
            minWidth: 6,
            rifleColor: "#666",
            trackBackgroundColor: gb("linearGradient",
                {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [[0, "#EEE"], [1, "#FFF"]]),
    ...
    Bb.prototype = {
        drawHandle: function (a, b) {
            ...
            if (!isNaN(a)) {
                ...
                a = c - b;
                if (!this.rendered) {
                    if (A)this.navigatorGroup = l = f.g("navigator").attr({zIndex: 3}).add(), this.leftShade = f.rect().attr({fill: r.maskFill}).add(l), this.rightShade = f.rect().attr({fill: r.maskFill}).add(l), this.outline = f.path().attr({
                        "stroke-width": I,
                        stroke: r.outlineColor
                    }).add(l);
                    if (q)this.scrollbarGroup = k = f.g("scrollbar").add(), m = x.trackBorderWidth,
                        this.scrollbarTrack = p = f.rect().attr({
                            y: -m % 2 / 2,
                            fill: x.trackBackgroundColor,
                            stroke: x.trackBorderColor,
                            "stroke-width": m,
                            r: x.trackBorderRadius || 0,
                            height: n
                        }).add(k), this.scrollbar = m = f.rect().attr({
                        y: -D % 2 / 2,
                        height: n,
                        fill: x.barBackgroundColor,
                        stroke: x.barBorderColor,
                        "stroke-width": D,
                        r: E
                    }).add(k), this.scrollbarRifles = f.path().attr({stroke: x.rifleColor, "stroke-width": 1}).add(k)
                }
                e = e.isResizing ? "animate" : "attr";
                A && (this.leftShade[e]({x: g, y: w, width: b, height: u}), this.rightShade[e]({
                    x: g + c,
                    y: w,
                    width: h - c,
                    height: u
                ...
                if (q && k)this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({
                    translateX: i,
                    translateY: v(B + u)
                }), p[e]({width: j}), g = n + b, h = a - D, h < t && (G = (t - h) / 2, h = t, g -= G), this.scrollbarPad = G, m[e]({
                    x: Q(g) + D % 2 / 2,
                    width: h
            ...
            a.navigatorEnabled ? (a.xAxis = c = new W(b, w({ordinal: m && m.xAxis.options.ordinal}, f.xAxis, {
                id: "navigator-x-axis",
                isX: !0,
                type: "datetime",
                index: p,
                ...
                index: n,
                zoomEnabled: !1
            })), m || f.series.data ? a.addBaseSeries() : b.series.length === 0 && U(b, "redraw",
                function (c, d) {
            ...
            if (!a || b.dataMin !== null)return {
                dataMin: o(d && d.min, (t(b.dataMin) && t(c.dataMin) ? y : o)(b.dataMin, c.dataMin)),
                dataMax: o(d && d.max, (t(b.dataMax) && t(c.dataMax) ? s : o)(b.dataMax, c.dataMax))
            }
    ...
    Cb.prototype = {
        clickButton: function (a, b) {
            ...
            if (!(j === null || k === null || a === c.selected)) {
                if (n === "month" || n === "year")l = {
                    month: "Month",
                    year: "FullYear"
                }[n], p["set" + l](p["get" + l]() - t), l = p.getTime(), j = o(j, Number.MIN_VALUE), isNaN(l) || l < j ? (l = j, m = y(l + i, k)) : i = m - l; else if (i)l = s(m - i, j), m =
        ...
        drawInput: function (a) {
            ...
            this[a + "Input"] = i = Z("input", {name: a, className: "highcharts-range-selector", type: "text"}, u({
        ...
        render: function (a, b) {
            ...
            if (!c.rendered &&
                ...
                }), c.updateButtonStates(), m))c.div = k = Z("div", null, {
                position: "relative",
                height: 0,
                zIndex: 1
            }), f.parentNode.insertBefore(k, f), c.inputGroup = k = e.g("input-group").add(),
                k.offset = 0, c.drawInput("min"), c.drawInput("max");
            m && (f = d.plotTop - 35, k.align(u({
                y: f,
                width: k.offset,
    ...
    U(W.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            ...
            if (!k)k = this.crossLabel = a.renderer.label().attr({
                align: f.align || b ? "center" : h ? this.labelAlign === "right" ? "right" : "center" : this.labelAlign === "left" ? "left" : "center",
                zIndex: 12,
                height: b ? 16 : r,
            ...
            }).css(u({color: "white", fontWeight: "normal", fontSize: "11px", textAlign: "center"}, f.style)).add();
            ...
            if (m < j || m > j + this.height)this.hideCrosshair(); else {
                ...
                k.attr({
                    x: l,
                    y: m,
                    text: p ? Ha(p, {value: c[g]}) : f.formatter.call(this, c[g]),
                    visibility: "visible"
                });
                c = k.box;
                if (b) {
