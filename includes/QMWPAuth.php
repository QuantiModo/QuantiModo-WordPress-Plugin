...
class QMWPAuth
{
    ...
    function __construct()
    {
        ...
        $this->urlAuth = QMWPAuth::QM_API_HOST . '/api/oauth2/authorize?';
        $this->urlToken = QMWPAuth::QM_API_HOST . '/api/oauth2/token?';
        $this->urlUser = QMWPAuth::QM_API_HOST . '/api/user/me?';
