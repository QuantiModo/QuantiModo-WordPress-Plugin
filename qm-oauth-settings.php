<?php
	...
	function qmoa_cc_security() {
		$points = 0;
		if (strpos(site_url(), "https://")) {
			$points += 2;
		}
		if (get_option('qmoa_hide_wordpress_login_form') == 1) {
			$points += 1;
		}
		if (get_option('qmoa_logout_inactive_users') > 0) {
			$points += 1;
		}
		if (get_option('qmoa_http_util_verify_ssl') == 1) {
			$points += 1;
		}
		if (get_option('qmoa_http_util') == 'curl') {
			$points += 1;
		}
		$points_max = 6;
	...
	function qmoa_cc_ux() {
		$points = 0;
		if (get_option('qmoa_logo_links_to_site') == 1) {
			$points += 1;
		}
		if (get_option('qmoa_show_login_messages') == 1) {
			$points += 1;
		}
		$points_max = 2;
		return floor(($points / $points_max) * 100);
	...
	$cc_security = qmoa_cc_security();
	$cc_privacy = qmoa_cc_privacy();
	$cc_ux = qmoa_cc_ux();
?>



<div class='wrap qmoa-settings'>
	<div id="qmoa-settings-meta">Toggle tips: <ul><li><a id="qmoa-settings-tips-on" href="#">On</a></li><li><a id="qmoa-settings-tips-off" href="#">Off</a></li></ul><div class="nav-splitter"></div>Toggle sections: <ul><li><a id="qmoa-settings-sections-on" href="#">On</a></li><li><a id="qmoa-settings-sections-off" href="#">Off</a></li></ul></div>
	<h2>QM-OAuth Settings</h2>
	<!-- START Settings Header -->
	<div id="qmoa-settings-header"></div>
	<!-- END Settings Header -->
	<!-- START Settings Body -->
	<div id="qmoa-settings-body">
	<!-- START Settings Column 2 -->
	<div id="qmoa-settings-col2" class="qmoa-settings-column">
		<div id="qmoa-settings-section-about" class="qmoa-settings-section">
			<h3>About</h3>
			<div class='form-padding'>
				<div id="qmoa-logo" style="width:64px; height:64px; float:right; background-size:100% 100%;"></div>
				<p><span style="font-size:1.1em;"><strong>QM-OAuth <?php echo WPOA::PLUGIN_VERSION; ?></strong></span><br/>by <a href="http://glassocean.net" target="_blank"><strong>Perry Butler</strong></a></p>
				<p>Rate it 5 stars: <a id="qmoa-rate-5stars" href="https://wordpress.org/support/view/plugin-reviews/qm-oauth?rate=5" target="_blank"><img src="http://ps.w.org/qm-oauth/assets/5stars.png" style="vertical-align:text-top;"></a></p>
				<nav><ul><li><a href="https://wordpress.org/plugins/qm-oauth/" target="_blank">QM-OAuth at WordPress.org</a></li><li><a href="https://github.com/perrybutler/QM-OAuth" target="_blank">QM-OAuth at GitHub.com</a></li><li><a href="http://glassocean.net/qm-oauth-enhances-your-wordpress-login-and-registration/" target="_blank">QM-OAuth at GlassOcean.net</a></li></ul></nav>
			</div>
		</div>
		<div id="qmoa-settings-section-news" class="qmoa-settings-section">
			<h3>News</h3>
			<div class='form-padding'>
				<?php 
		...
		<div id="qmoa-settings-section-config-check" class="qmoa-settings-section">
		<h3>Config Check</h3>
			<div class='form-padding'>
				<p>These ratings are an estimate of <em>this plugin's current configuration</em> when compared to an optimum configuration.</p>
				<div id='qmoa-measurements'>
					<div class="has-tip">
						<div class="qmoa-measurement-label">Security: <?php echo $cc_security; ?>% <a href="#" class="tip-button">[?]</a></div>
						<div class="qmoa-measurement"><div class="qmoa-measurement-rating" style="width:<?php echo $cc_security; ?>%;"></div></div>
						<p class="tip-message">
					...
					<div class="has-tip">
						<div class="qmoa-measurement-label">Privacy: <?php echo $cc_privacy; ?>% <a href="#" class="tip-button">[?]</a></div>
						<div class="qmoa-measurement"><div class="qmoa-measurement-rating" style="width:<?php echo $cc_privacy; ?>%;"></div></div>
						<p class="tip-message">
							+1 if Automatically logout inactive users = True<br/>
						</p>
					</div>
					<div class="has-tip">
						<div class="qmoa-measurement-label">User Experience: <?php echo $cc_ux; ?>% <a href="#" class="tip-button">[?]</a></div>
						<div class="qmoa-measurement"><div class="qmoa-measurement-rating" style="width:<?php echo $cc_ux; ?>%;"></div></div>
						<p class="tip-message">
		...
		<div id="qmoa-settings-section-donate" class="qmoa-settings-section">
			<h3>Donate</h3>
			<div class='form-padding'>
				<div id="qmoa-heart"></div>
				<p>Do you enjoy using this plugin? Do you want to help improve it? Consider donating via <strong>PayPal</strong>!</p><p>QM-OAuth remains free of restrictions, advertisements, branding, etc. <em>Your donations help make this possible.</em></p>
				<form action="https://www.paypal.com/cgi-bin/webscr" target="_blank" method="post">
					...
					<input type="hidden" value="QM-OAuth" name="item_name">
					<input type="hidden" value="0" name="no_shipping">
					<input type="hidden" value="1" name="no_note">
					<input type="hidden" value="Return to your dashboard" name="cbt">
					<input type="hidden" value="USD" name="currency_code">
					<input type="submit" id="qmoa-paypal-button" class="button" value="Donate">
				</form>
			</div>
		</div>
		<div id="qmoa-settings-section-live-demo" class="qmoa-settings-section">
		...
		<div id="qmoa-settings-section-support" class="qmoa-settings-section">
			<h3 id="bookmark-login-page-form-customization">Support</h3>
			<div class='form-padding'>
				<p>Your general questions can be asked in the plugin <a href="https://wordpress.org/support/plugin/qm-oauth" target="_blank">support forum</a>.</p>
			</div>
		</div>
	</div>
	<!-- END Settings Column 2 -->
	<!-- START Settings Column 1 -->
	<div id="qmoa-settings-col1" class="qmoa-settings-column">
		<form method='post' action='options.php'>
			<?php settings_fields('qmoa_settings'); ?>
			<?php do_settings_sections('qmoa_settings'); ?>
			<!-- START General Settings section -->
			<div id="qmoa-settings-section-general-settings" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<td>
					<input type='checkbox' name='qmoa_show_login_messages' value='1' <?php checked(get_option('qmoa_show_login_messages') == 1); ?> />
				...
				<td>
					<select name='qmoa_login_redirect'>
						<option value='home_page' <?php selected(get_option('qmoa_login_redirect'), 'home_page'); ?>>Home Page</option>
						<option value='last_page' <?php selected(get_option('qmoa_login_redirect'), 'last_page'); ?>>Last Page</option>
						<option value='specific_page' <?php selected(get_option('qmoa_login_redirect'), 'specific_page'); ?>>Specific Page</option>
						<option value='admin_dashboard' <?php selected(get_option('qmoa_login_redirect'), 'admin_dashboard'); ?>>Admin Dashboard</option>
						<option value='user_profile' <?php selected(get_option('qmoa_login_redirect'), 'user_profile'); ?>>User's Profile Page</option>
						<option value='custom_url' <?php selected(get_option('qmoa_login_redirect'), 'custom_url'); ?>>Custom URL</option>
					</select>
					<?php wp_dropdown_pages(array("id" => "qmoa_login_redirect_page", "name" => "qmoa_login_redirect_page", "selected" => get_option('qmoa_login_redirect_page'))); ?>
					<input type="text" name="qmoa_login_redirect_url" value="<?php echo get_option('qmoa_login_redirect_url'); ?>" style="display:none;" />
				...
				<td>
					<select name='qmoa_logout_redirect'>
						<option value='default_handling' <?php selected(get_option('qmoa_logout_redirect'), 'default_handling'); ?>>Let WordPress handle it</option>
						<option value='home_page' <?php selected(get_option('qmoa_logout_redirect'), 'home_page'); ?>>Home Page</option>
						<option value='last_page' <?php selected(get_option('qmoa_logout_redirect'), 'last_page'); ?>>Last Page</option>
						<option value='specific_page' <?php selected(get_option('qmoa_logout_redirect'), 'specific_page'); ?>>Specific Page</option>
						<option value='admin_dashboard' <?php selected(get_option('qmoa_logout_redirect'), 'admin_dashboard'); ?>>Admin Dashboard</option>
						<option value='user_profile' <?php selected(get_option('qmoa_logout_redirect'), 'user_profile'); ?>>User's Profile Page</option>
						<option value='custom_url' <?php selected(get_option('qmoa_logout_redirect'), 'custom_url'); ?>>Custom URL</option>
					</select>
					<?php wp_dropdown_pages(array("id" => "qmoa_logout_redirect_page", "name" => "qmoa_logout_redirect_page", "selected" => get_option('qmoa_logout_redirect_page'))); ?>
					<input type="text" name="qmoa_logout_redirect_url" value="<?php echo get_option('qmoa_logout_redirect_url'); ?>" style="display:none;" />
				...
				<td>
					<select name='qmoa_logout_inactive_users'>
						<option value='0' <?php selected(get_option('qmoa_logout_inactive_users'), '0'); ?>>Never</option>
						<option value='1' <?php selected(get_option('qmoa_logout_inactive_users'), '1'); ?>>After 1 minute</option>
						<option value='5' <?php selected(get_option('qmoa_logout_inactive_users'), '5'); ?>>After 5 minutes</option>
						<option value='15' <?php selected(get_option('qmoa_logout_inactive_users'), '15'); ?>>After 15 minutes</option>
						<option value='30' <?php selected(get_option('qmoa_logout_inactive_users'), '30'); ?>>After 30 minutes</option>
						<option value='60' <?php selected(get_option('qmoa_logout_inactive_users'), '60'); ?>>After 1 hour</option>
						<option value='120' <?php selected(get_option('qmoa_logout_inactive_users'), '120'); ?>>After 2 hours</option>
			...
			<div id="qmoa-settings-section-login-forms" class="qmoa-settings-section">
			<h3>Login Forms</h3>
			<div class='form-padding'>
			<table class='form-table'>
				...
				<td>
					<input type='checkbox' name='qmoa_hide_wordpress_login_form' value='1' <?php checked(get_option('qmoa_hide_wordpress_login_form') == 1); ?> />
				...
				<td>
					<input type='checkbox' name='qmoa_logo_links_to_site' value='1' <?php checked(get_option('qmoa_logo_links_to_site') == 1); ?> />
				...
				<td>
					<p>
					<input id='qmoa_logo_image' type='text' size='' name='qmoa_logo_image' value="<?php echo get_option('qmoa_logo_image'); ?>" />
					<input id='qmoa_logo_image_button' type='button' class='button' value='Select' />
					</p>
				...
				<td>
					<p>
					<input id='qmoa_bg_image' type='text' size='' name='qmoa_bg_image' value="<?php echo get_option('qmoa_bg_image'); ?>" />
					<input id='qmoa_bg_image_button' type='button' class='button' value='Select' />
					</p>
				...
				<td>
					<?php echo WPOA::qmoa_login_form_designs_selector('qmoa-login-form-show-login-screen'); ?>
				...
				<td>
					<?php echo WPOA::qmoa_login_form_designs_selector('qmoa-login-form-show-profile-page'); ?>
					<p class="tip-message">Create or manage these login form designs in the CUSTOM LOGIN FORM DESIGNS section.</p>
				</td>
				</tr>
				...
				<td>
					<?php echo WPOA::qmoa_login_form_designs_selector('qmoa-login-form-show-comments-section'); ?>
					<p class="tip-message">Create or manage these login form designs in the CUSTOM LOGIN FORM DESIGNS section.</p>
				</td>
				</tr>
			</table> <!-- .form-table -->
			...
			<table class='form-table'>
				...
				<td>
					<?php echo WPOA::qmoa_login_form_designs_selector('qmoa-login-form-design', true); ?>
					<p>
			...
			<table class="form-table" id="qmoa-login-form-design-form">
				...
				<td>
					<input id='qmoa-login-form-design-name' type='text' size='36' name='qmoa_login_form_design_name' value="" />
				...
				<td>
					<select name='qmoa_login_form_icon_set'>
				...
				<td>
					<select name='qmoa_login_form_show_login'>
				...
				<td>
					<select name='qmoa_login_form_show_logout'>
						<option value='always'>Always</option>
						<option value='conditional'>Conditional</option>
						<option value='never'>Never</option>
					</select>
				...
				<td>
					<select name='qmoa_login_form_layout'>
				...
				<td>
					<input id='qmoa_login_form_button_prefix' type='text' size='36' name='qmoa_login_form_button_prefix' value="" />
				...
				<td>
					<input id='qmoa_login_form_logged_out_title' type='text' size='36' name='qmoa_login_form_logged_out_title' value="" />
				...
				<td>
					<input id='qmoa_login_form_logged_in_title' type='text' size='36' name='qmoa_login_form_logged_in_title' value="" />
				...
				<td>
					<input id='qmoa_login_form_logging_in_title' type='text' size='36' name='qmoa_login_form_logging_in_title' value="" />
				...
				<td>
					<input id='qmoa_login_form_logging_out_title' type='text' size='36' name='qmoa_login_form_logging_out_title' value="" />
					<p class="tip-message">Sets the text to be displayed above the login form for users who are logging out.</p>
				</td>
				</tr>
				
				<tr valign='top' id='qmoa-login-form-actions'>
				<th scope='row'>
					<input type="button" id="qmoa-login-form-ok" name="qmoa_login_form_ok" class="button" value="OK">
					<input type="button" id="qmoa-login-form-cancel" name="qmoa_login_form_cancel" class="button" value="Cancel">
				</th>
				<td>
			...
			<div id="qmoa-settings-section-user-registration" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<td>
					<input type='checkbox' name='qmoa_suppress_welcome_email' value='1' <?php checked(get_option('qmoa_suppress_welcome_email') == 1); ?> />
				...
				<td>
					<select name="qmoa_new_user_role"><?php wp_dropdown_roles(get_option('qmoa_new_user_role')); ?></select>
            ...
            <div id="qmoa-settings-section-login-with-quantimodo" class="qmoa-settings-section">
                ...
                <div class='form-padding'>
                    <table class='form-table'>
                        <tr valign='top'>
                            ...
                            <td>
                                <input type='checkbox' name='qmoa_quantimodo_api_enabled' value='1' <?php checked(get_option('qmoa_quantimodo_api_enabled') == 1); ?> />
                            </td>
                        </tr>
                        ...
                        <tr valign='top'>
                            ...
                            <td>
                                <input type='text' name='qmoa_quantimodo_api_id' value='<?php echo get_option('qmoa_quantimodo_api_id'); ?>' />
                            </td>
                        </tr>
                        ...
                        <tr valign='top'>
                            ...
                            <td>
                                <input type='text' name='qmoa_quantimodo_api_secret' value='<?php echo get_option('qmoa_quantimodo_api_secret'); ?>' />
                            </td>
                        </tr>
                    </table> <!-- .form-table -->
                    <p>
                    ...
                    <ol>
                        <li>Visit the QuantiModo website for developers <a href='https://console.developers.quantimodo.com/project' target="_blank">console.developers.quantimodo.com</a>.</li>
                        <li>At QuantiModo, create a new Project and enable the QuantiModo+ API. This will enable your site to access the QuantiModo+ API.</li>
                        <li>At QuantiModo, provide your site's homepage URL (<?php echo $blog_url; ?>) for the new Project's Redirect URI. Don't forget the trailing slash!</li>
                        <li>At QuantiModo, you must also configure the Consent Screen with your Email Address and Product Name. This is what QuantiModo will display to users when they are asked to grant access to your site/app.</li>
                        <li>Paste your Client ID/Secret provided by QuantiModo into the fields above, then click the Save all settings button.</li>
                    </ol>
                    </p>
                    <?php submit_button('Save all settings'); ?>
                </div> <!-- .form-padding -->
			...
			<div id="qmoa-settings-section-login-with-google" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_google_api_enabled' value='1' <?php checked(get_option('qmoa_google_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='qmoa_google_api_id' value='<?php echo get_option('qmoa_google_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='qmoa_google_api_secret' value='<?php echo get_option('qmoa_google_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<div id="qmoa-settings-section-login-with-facebook" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_facebook_api_enabled' value='1' <?php checked(get_option('qmoa_facebook_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<td>
					<input type='text' name='qmoa_facebook_api_id' value='<?php echo get_option('qmoa_facebook_api_id'); ?>' />
				</td>
				</tr>
				...
				<td>
					<input type='text' name='qmoa_facebook_api_secret' value='<?php echo get_option('qmoa_facebook_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<div id="qmoa-settings-section-login-with-linkedin" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_linkedin_api_enabled' value='1' <?php checked(get_option('qmoa_linkedin_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<td>
					<input type='text' name='qmoa_linkedin_api_id' value='<?php echo get_option('qmoa_linkedin_api_id'); ?>' />
				</td>
				</tr>
				...
				<td>
					<input type='text' name='qmoa_linkedin_api_secret' value='<?php echo get_option('qmoa_linkedin_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<div id="qmoa-settings-section-login-with-github" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_github_api_enabled' value='1' <?php checked(get_option('qmoa_github_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='qmoa_github_api_id' value='<?php echo get_option('qmoa_github_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='qmoa_github_api_secret' value='<?php echo get_option('qmoa_github_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<div id="qmoa-settings-section-login-with-reddit" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_reddit_api_enabled' value='1' <?php checked(get_option('qmoa_reddit_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='qmoa_reddit_api_id' value='<?php echo get_option('qmoa_reddit_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='qmoa_reddit_api_secret' value='<?php echo get_option('qmoa_reddit_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<div id="qmoa-settings-section-login-with-windowslive" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_windowslive_api_enabled' value='1' <?php checked(get_option('qmoa_windowslive_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='qmoa_windowslive_api_id' value='<?php echo get_option('qmoa_windowslive_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='qmoa_windowslive_api_secret' value='<?php echo get_option('qmoa_windowslive_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<div id="qmoa-settings-section-login-with-paypal" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_paypal_api_enabled' value='1' <?php checked(get_option('qmoa_paypal_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<td>
					<input type='checkbox' name='qmoa_paypal_api_sandbox_mode' value='1' <?php checked(get_option('qmoa_paypal_api_sandbox_mode') == 1); ?> />
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='qmoa_paypal_api_id' value='<?php echo get_option('qmoa_paypal_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='qmoa_paypal_api_secret' value='<?php echo get_option('qmoa_paypal_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<div id="qmoa-settings-section-login-with-instagram" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_instagram_api_enabled' value='1' <?php checked(get_option('qmoa_instagram_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Client ID:</th>
				<td>
					<input type='text' name='qmoa_instagram_api_id' value='<?php echo get_option('qmoa_instagram_api_id'); ?>' />
				</td>
				</tr>
				...
				<th scope='row'>Client Secret:</th>
				<td>
					<input type='text' name='qmoa_instagram_api_secret' value='<?php echo get_option('qmoa_instagram_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
			...
			<div id="qmoa-settings-section-login-with-battlenet" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<th scope='row'>Enabled:</th>
				<td>
					<input type='checkbox' name='qmoa_battlenet_api_enabled' value='1' <?php checked(get_option('qmoa_battlenet_api_enabled') == 1); ?> />
				</td>
				</tr>
				...
				<th scope='row'>Key:</th>
				<td>
					<input type='text' name='qmoa_battlenet_api_id' value='<?php echo get_option('qmoa_battlenet_api_id'); ?>' />
				</td>
				</tr>
				...
				<td>
					<input type='text' name='qmoa_battlenet_api_secret' value='<?php echo get_option('qmoa_battlenet_api_secret'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			...
			<div id="qmoa-settings-section-back-channel=configuration" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<td>
					<select name='qmoa_http_util'>
						<option value='curl' <?php selected(get_option('qmoa_http_util'), 'curl'); ?>>cURL</option>
						<option value='stream-context' <?php selected(get_option('qmoa_http_util'), 'stream-context'); ?>>Stream Context</option>
					</select>
				...
				<td>
					<input type='checkbox' name='qmoa_http_util_verify_ssl' value='1' <?php checked(get_option('qmoa_http_util_verify_ssl') == 1); ?> />
			...
			<div id="qmoa-settings-section-maintenance-troubleshooting" class="qmoa-settings-section">
			...
			<table class='form-table'>
				...
				<td>
					<input type='checkbox' name='qmoa_restore_default_settings' value='1' <?php checked(get_option('qmoa_restore_default_settings') == 1); ?> />
				...
				<td>
					<input type='checkbox' name='qmoa_delete_settings_on_uninstall' value='1' <?php checked(get_option('qmoa_delete_settings_on_uninstall') == 1); ?> />
	...
	</div> <!-- #qmoa-settings-body -->
	<!-- END Settings Body -->
</div> <!-- .wrap .qmoa-settings -->